...
sealed class Screen {
    ...
    @Serializable object EligibilityChecker : Screen()
    @Serializable object Schemes : Screen()
    @Serializable data class SchemeDetail(val schemeId: String) : Screen()
    @Serializable object Hospitals : Screen()
    @Serializable object Profile : Screen()
    @Serializable object Settings : Screen()
    @Serializable object Chatbot : Screen()
}
